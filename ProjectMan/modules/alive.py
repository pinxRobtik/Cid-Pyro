...
async def alive(client: Client, message: Message):
    ...
    man = (
        f"**[PyroCID-Userbot](https://github.com/pinxRobtik/Cid-Pyro) is Up and Running.**\n\n"
        f"<b>{alive_text}</b>\n\n"
        ...
        f"    **[𝗦𝘂𝗽𝗽𝗼𝗿𝘁](https://t.me/cidsupport{GROUP})** | **[𝗖𝗵𝗮𝗻𝗻𝗲𝗹](https://t.me/menfeschkagenou{CHANNEL})** | **[𝗢𝘄𝗻𝗲𝗿](tg://user?id={client.me.id})**"
    )
    try:
